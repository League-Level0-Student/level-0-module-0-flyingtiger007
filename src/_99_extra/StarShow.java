...
batman.setRandomPenColor();			// Increase the number of stars that have been drawn by 1,
...
while (lines < 5) {
	...
	lines+=1;
				...
				// COUNT. Add one to		// TURN the robot 144 degrees
