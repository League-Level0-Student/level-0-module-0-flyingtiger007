...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String adjective = JOptionPane.showInputDialog(null,"enter a random adjective");
		// Get the player to enter a type of liquid
		String liquid = JOptionPane.showInputDialog(null,"enter a random liquid");
		// Get the player to enter a body part
		String bodypart = JOptionPane.showInputDialog(null,"enter a random bodypart");
		// Get the player to enter a verb
		String verb = JOptionPane.showInputDialog(null,"enter a random verb");
		// Get the3 player to enter a place
		String place = JOptionPane.showInputDialog(null,"enter a random place");
